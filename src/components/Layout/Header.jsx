...
const Header = ({ sideBarCollapsed, onToggleSidebar, darkMode, setDarkMode }) => {
  return (
    <div className=" dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 
                px-1 sm:px-6 lg:px-6
                py-4 sm:py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex-1 max-w-md mx-0 lg:mx-8 ">
          <div className="relative">
            ...
            <input
              ...
              className="w-48 lg:w-full text-sm sm:text-base pl-10  pr-4 py-2.5 lg:py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl
             text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            />
            <button
              className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5
            text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"
            >
              <Filter className="w-4 lg:w-6" />
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-0 lg:space-x-3">
          {/* Quick Action */}
          <button
            className="hidden lg:flex items-center space-x-2 py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl
