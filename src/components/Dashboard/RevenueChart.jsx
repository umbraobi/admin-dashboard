...
const RevenueChart = () => {
    ...
    return (
        <div
            className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-b-2xl border border-slate-200/50
        ...
        >
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 bg-gradient-to-r from-slate-400 to-slatre-500 rounded-full"></div>
                        <div className="text-sm text-slate-600 dark:text-slate-400">
                            <span>Expenses</span>
                        </div>
                    </div>
